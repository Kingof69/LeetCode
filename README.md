...
| 42  | [Trapping Rain Water](https://leetcode.com/problems/trapping-rain-water/) ♥ | [Python](https://github.com/TranDucThien-0509/LeetCode/blob/main/NeetCode/Two%20Pointers/42.%20Trapping%20Rain%20Water.py) | Go left → right, trap when you see a taller wall.
If not, go right → left using the tallest wall on the right.    |
